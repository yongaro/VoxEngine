...
PrairieGenerator::~PrairieGenerator() {}

  int PrairieGenerator::getNbBloc(int nb) const {
  	int random = rand() % 100;
  if (random < 5) {
    return -1;
  } else if (random > 55) {
  ...
  double PrairieGenerator::getProbaAir(int height, int maxHeight) const {
	return std::max((double(height) / maxHeight) - 0.5 * maxHeight, 0.0);
}

  double PrairieGenerator::getProbaAdminium(int height, int maxHeight) const {
  ...
  double PrairieGenerator::getProbaCactus(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.9) {
		return 0.0;
	} else {
  ...
  double PrairieGenerator::getProbaCoal(int height, int maxHeight) const {
  ...
  double PrairieGenerator::getProbaDirt(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.7) {
		return 0.2;
	} else {
  ...
  double PrairieGenerator::getProbaFolliage(int height, int maxHeight) const {
	return 0.0;
}

  double PrairieGenerator::getProbaGlowstone(int height, int maxHeight) const {
	return 0.0;
}

  double PrairieGenerator::getProbaGold(int height, int maxHeight) const {
	return getProbaCoal(height * 0.5, maxHeight) * 0.1;
}

  double PrairieGenerator::getProbaDiamond(int height, int maxHeight) const {
	return getProbaGold(height * 0.7, maxHeight);
}

  double PrairieGenerator::getProbaGrass(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (height == maxHeight) {
		return 0.9;
	} else if (u > 0.8) {
  ...
  double PrairieGenerator::getProbaIron(int height, int maxHeight) const {
	return getProbaCoal(height, maxHeight) * 0.5;
}

  double PrairieGenerator::getProbaSand(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.9) {
		return 0.0;
	} else {
  ...
  double PrairieGenerator::getProbaSnow(int height, int maxHeight) const {
	return 0;
}

  double PrairieGenerator::getProbaSnowBlock(int height, int maxHeight) const {
	return 0;
}

  double PrairieGenerator::getProbaStone(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.9) {
		return 0.01;
	} else {
  ...
  double PrairieGenerator::getProbaWater(int height, int maxHeight, int superMaxHeight) const {
	double u = double(height) / maxHeight;
  ...
  double PrairieGenerator::getProbaWood(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.9) {
		return 0.01;
	} else {
 ...
 std::vector<double> PrairieGenerator::getProbaBloc(int depth, int maxHeight, int superMaxHeight) const {
  ...
  void PrairieGenerator::growRiver(cimg_library::CImg<unsigned char>& map) const {
   ...
   void PrairieGenerator::diffuseFolliage(cimg_library::CImg<unsigned char>& map) const {
	int hSize = map.height();
	int wSize = map.width();
	int dSize = map.depth();
   ...
   void PrairieGenerator::growTree (cimg_library::CImg<unsigned char>& map) const {
	int hSize = map.height();
	int wSize = map.width();
	int dSize = map.depth();
 ...
 void PrairieGenerator::fill(cimg_library::CImg<unsigned char>& map) {
	int hSize = map.height();
	int wSize = map.width();
	int dSize = map.depth();
