...
PrairieGenerator::~PrairieGenerator() {}
 ...
 std::vector<double> PrairieGenerator::getProbaBloc(int depth, int maxHeight, int superMaxHeight) const {
  ...
  void PrairieGenerator::growRiver(VoxImage<unsigned char>& map) const {
   ...
   void PrairieGenerator::diffuseFolliage(VoxImage<unsigned char>& map) const {
	int hSize = map.height();
	int wSize = map.width();
	int dSize = map.depth();
   ...
   void PrairieGenerator::growTree (VoxImage<unsigned char>& map) const {
	int hSize = map.height();
	int wSize = map.width();
	int dSize = map.depth();
 ...
 void PrairieGenerator::fill(VoxImage<unsigned char>& map) {
	int hSize = map.height();
	int wSize = map.width();
	int dSize = map.depth();
