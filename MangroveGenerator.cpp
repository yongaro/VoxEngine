...
MangroveGenerator::~MangroveGenerator() {}

  int MangroveGenerator::getNbBloc(int nb) const {
  	int random = rand() % 100;
  if (random < 5) {
    return -1;
  } else if (random > 60) {
  ...
  double MangroveGenerator::getProbaAir(int height, int maxHeight) const {
	return std::max((double(height) / maxHeight) - 0.5 * maxHeight, 0.0);
}

  double MangroveGenerator::getProbaAdminium(int height, int maxHeight) const {
  ...
  double MangroveGenerator::getProbaCactus(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.9) {
		return 0.0;
	} else {
  ...
  double MangroveGenerator::getProbaCoal(int height, int maxHeight) const {
  ...
  double MangroveGenerator::getProbaDirt(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.7) {
		return 0.2;
	} else {
  ...
  double MangroveGenerator::getProbaFolliage(int height, int maxHeight) const {
	return 0.0;
}

  double MangroveGenerator::getProbaGlowstone(int height, int maxHeight) const {
	return 0.0;
}

  double MangroveGenerator::getProbaGold(int height, int maxHeight) const {
	return getProbaCoal(height * 0.5, maxHeight) * 0.1;
}

  double MangroveGenerator::getProbaDiamond(int height, int maxHeight) const {
	return getProbaGold(height * 0.7, maxHeight);
}

  double MangroveGenerator::getProbaGrass(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (height == maxHeight) {
		return 0.9;
	} else if (u > 0.8) {
  ...
  double MangroveGenerator::getProbaIron(int height, int maxHeight) const {
	return getProbaCoal(height, maxHeight) * 0.5;
}

  double MangroveGenerator::getProbaSand(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.9) {
		return 0.0;
	} else {
  ...
  double MangroveGenerator::getProbaSnow(int height, int maxHeight) const {
	return 0;
}

  double MangroveGenerator::getProbaSnowBlock(int height, int maxHeight) const {
	return 0;
}

  double MangroveGenerator::getProbaStone(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.9) {
		return 0.01;
	} else {
  ...
  double MangroveGenerator::getProbaWood(int height, int maxHeight) const {
	double u = double(height) / maxHeight;
	if (u > 0.9) {
		return 0.05;
	} else {
 ...
 std::vector<double> MangroveGenerator::getProbaBloc(int depth, int maxHeight, int superMaxHeight) const {
